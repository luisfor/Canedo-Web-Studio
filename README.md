# Kit Agencia Luis Canedo — para Claude Code
...
cliente (logo, colores, fotos, precios) y la reconstruye con un **diseño premium de agencia**
— lista para enseñársela al cliente y vender.
...
| `.claude/skills/luis-rediseño-premium/` | La skill: el sistema completo de rediseño premium |
| `.claude/skills/luis-estudio-web/` | La skill para crear desde cero y publicar en Local, Hostinger o Cloudflare |
...
| `despliegue.md` | Cómo publicarla: publicación real y automática en Hostinger o Cloudflare Pages |
